...
## Table of Contents:
  ##   45 Text Mining (Lauren)
  ##  272 Read in Data and Explore (Lauren)
  ##  323 Update Variable Name (Lauren)
  ##  422 Visual of Bar Charts (Lauren)
  ##  540 Create Test and Train (Baskar)
  ##  578 Decision Tree (Baskar)
  ##  666 Random Forest (Baskar)
  ##  730 K-Nearest Neighbors (Baskar)
  ##  766 Support Vector Machines (Baskar)
  ##  816 Clustering (Baskar)
  ## 1007 Naïve Bayes (Lauren)
  ## 1070 Association Rules Mining (Lauren)
...
## Choose parameters (either 1 visual at a time or 2x2=4 per page)
par(mfrow=c(1,1))
#par(mfrow=c(2,2))
...
## Do the prediction
#mush_test_nolabels #Don't want to print this
...
## We can do this for all other combinations but looks like Odor and Spore.print.color is variables of Importance.
...
#print(result.kmean) #don't want to print this
...
#print(result.kmode) #Don't want to print this
...
#print(result.kmode3) #Don't want to print this
...
#print(result.kmode4) #Don't want to print this
...
#print(result.kmode5) #Don't want to print this
