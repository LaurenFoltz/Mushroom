...
## Last run on R Version: 3.6.1 Eggshell Igloo
## Some addional notes added for Markdown
...
cat("[1]","Number of Documents:",(ndocs<-length(Corpus)),"\n") 
...
## Perform Checks, by viewing and/or inspecting
paste("View of dtm:")
(dtm)
...
cat("[1]","Number of Rows:",(nrow(mush_DF)),"\n") 
...
Total <-sum(is.na(m))
cat("[1]", "The number of missing values in Mushroom data is: ", Total,"\n" )
...
```{r}
#==================================================================================================
#Support Vector Machines (Baskar Dakshin)
#==================================================================================================
